    ...
    public class KratosIdentityJsonConverter : JsonConverter<KratosIdentity>
    {
        ...
        public override KratosIdentity Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (externalId.IsSet && externalId.Value == null)
                throw new ArgumentNullException(nameof(externalId), "Property is not nullable for class KratosIdentity.");
            ...
            return new KratosIdentity(id.Value!, schemaId.Value!, schemaUrl.Value!, createdAt, credentials, externalId, metadataAdmin, metadataPublic, organizationId, recoveryAddresses, state, stateChangedAt, traits.Value!, updatedAt, verifiableAddresses);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, KratosIdentity kratosIdentity, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (kratosIdentity.ExternalIdOption.IsSet && kratosIdentity.ExternalId == null)
                throw new ArgumentNullException(nameof(kratosIdentity.ExternalId), "Property is required for class KratosIdentity.");
            ...
            if (kratosIdentity.ExternalIdOption.IsSet)
                writer.WriteString("external_id", kratosIdentity.ExternalId);
