...
namespace LeanCode.Kratos.Client.Model
{
    ...
    public partial class KratosLoginFlow
    {
        ...
        [JsonConstructor]
        public KratosLoginFlow(DateTime expiresAt, string id, DateTime issuedAt, string requestUrl, string type, KratosUiContainer ui, Option<ActiveEnum?> active = default, Option<DateTime?> createdAt = default, Option<string?> identitySchema = default, Option<string?> oauth2LoginChallenge = default, Option<KratosOAuth2LoginRequest?> oauth2LoginRequest = default, Option<string?> organizationId = default, Option<bool?> refresh = default, Option<KratosAuthenticatorAssuranceLevel?> requestedAal = default, Option<string?> returnTo = default, Option<string?> sessionTokenExchangeCode = default, Object? state = default, Option<Object?> transientPayload = default, Option<DateTime?> updatedAt = default)
        {
            ExpiresAt = expiresAt;
            Id = id;
            IssuedAt = issuedAt;
    ...
    public class KratosLoginFlowJsonConverter : JsonConverter<KratosLoginFlow>
    {
        ...
        public override KratosLoginFlow Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (identitySchema.IsSet && identitySchema.Value == null)
                throw new ArgumentNullException(nameof(identitySchema), "Property is not nullable for class KratosLoginFlow.");
            ...
            return new KratosLoginFlow(expiresAt.Value!.Value!, id.Value!, issuedAt.Value!.Value!, requestUrl.Value!, type.Value!, ui.Value!, active, createdAt, identitySchema, oauth2LoginChallenge, oauth2LoginRequest, organizationId, refresh, requestedAal, returnTo, sessionTokenExchangeCode, state.Value!, transientPayload, updatedAt);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, KratosLoginFlow kratosLoginFlow, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (kratosLoginFlow.IdentitySchemaOption.IsSet && kratosLoginFlow.IdentitySchema == null)
                throw new ArgumentNullException(nameof(kratosLoginFlow.IdentitySchema), "Property is required for class KratosLoginFlow.");
            ...
            if (kratosLoginFlow.IdentitySchemaOption.IsSet)
                writer.WriteString("identity_schema", kratosLoginFlow.IdentitySchema);
