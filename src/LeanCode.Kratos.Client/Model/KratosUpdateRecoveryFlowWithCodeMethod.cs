...
namespace LeanCode.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateRecoveryFlowWithCodeMethod
    {
        ...
        [JsonConstructor]
        public KratosUpdateRecoveryFlowWithCodeMethod(MethodEnum method, Option<string?> code = default, Option<string?> csrfToken = default, Option<string?> email = default, Option<string?> recoveryAddress = default, Option<string?> recoveryConfirmAddress = default, Option<string?> recoverySelectAddress = default, Option<string?> screen = default, Option<Object?> transientPayload = default)
        {
            Method = method;
            CodeOption = code;
    ...
    public class KratosUpdateRecoveryFlowWithCodeMethodJsonConverter : JsonConverter<KratosUpdateRecoveryFlowWithCodeMethod>
    {
        ...
        public override KratosUpdateRecoveryFlowWithCodeMethod Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (recoveryAddress.IsSet && recoveryAddress.Value == null)
                throw new ArgumentNullException(nameof(recoveryAddress), "Property is not nullable for class KratosUpdateRecoveryFlowWithCodeMethod.");

            if (recoveryConfirmAddress.IsSet && recoveryConfirmAddress.Value == null)
                throw new ArgumentNullException(nameof(recoveryConfirmAddress), "Property is not nullable for class KratosUpdateRecoveryFlowWithCodeMethod.");

            if (recoverySelectAddress.IsSet && recoverySelectAddress.Value == null)
                throw new ArgumentNullException(nameof(recoverySelectAddress), "Property is not nullable for class KratosUpdateRecoveryFlowWithCodeMethod.");

            if (screen.IsSet && screen.Value == null)
                throw new ArgumentNullException(nameof(screen), "Property is not nullable for class KratosUpdateRecoveryFlowWithCodeMethod.");
            ...
            return new KratosUpdateRecoveryFlowWithCodeMethod(method.Value!.Value!, code, csrfToken, email, recoveryAddress, recoveryConfirmAddress, recoverySelectAddress, screen, transientPayload);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, KratosUpdateRecoveryFlowWithCodeMethod kratosUpdateRecoveryFlowWithCodeMethod, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (kratosUpdateRecoveryFlowWithCodeMethod.RecoveryAddressOption.IsSet && kratosUpdateRecoveryFlowWithCodeMethod.RecoveryAddress == null)
                throw new ArgumentNullException(nameof(kratosUpdateRecoveryFlowWithCodeMethod.RecoveryAddress), "Property is required for class KratosUpdateRecoveryFlowWithCodeMethod.");

            if (kratosUpdateRecoveryFlowWithCodeMethod.RecoveryConfirmAddressOption.IsSet && kratosUpdateRecoveryFlowWithCodeMethod.RecoveryConfirmAddress == null)
                throw new ArgumentNullException(nameof(kratosUpdateRecoveryFlowWithCodeMethod.RecoveryConfirmAddress), "Property is required for class KratosUpdateRecoveryFlowWithCodeMethod.");

            if (kratosUpdateRecoveryFlowWithCodeMethod.RecoverySelectAddressOption.IsSet && kratosUpdateRecoveryFlowWithCodeMethod.RecoverySelectAddress == null)
                throw new ArgumentNullException(nameof(kratosUpdateRecoveryFlowWithCodeMethod.RecoverySelectAddress), "Property is required for class KratosUpdateRecoveryFlowWithCodeMethod.");

            if (kratosUpdateRecoveryFlowWithCodeMethod.ScreenOption.IsSet && kratosUpdateRecoveryFlowWithCodeMethod.Screen == null)
                throw new ArgumentNullException(nameof(kratosUpdateRecoveryFlowWithCodeMethod.Screen), "Property is required for class KratosUpdateRecoveryFlowWithCodeMethod.");
            ...
            if (kratosUpdateRecoveryFlowWithCodeMethod.RecoveryAddressOption.IsSet)
                writer.WriteString("recovery_address", kratosUpdateRecoveryFlowWithCodeMethod.RecoveryAddress);

            if (kratosUpdateRecoveryFlowWithCodeMethod.RecoveryConfirmAddressOption.IsSet)
                writer.WriteString("recovery_confirm_address", kratosUpdateRecoveryFlowWithCodeMethod.RecoveryConfirmAddress);

            if (kratosUpdateRecoveryFlowWithCodeMethod.RecoverySelectAddressOption.IsSet)
                writer.WriteString("recovery_select_address", kratosUpdateRecoveryFlowWithCodeMethod.RecoverySelectAddress);

            if (kratosUpdateRecoveryFlowWithCodeMethod.ScreenOption.IsSet)
                writer.WriteString("screen", kratosUpdateRecoveryFlowWithCodeMethod.Screen);
