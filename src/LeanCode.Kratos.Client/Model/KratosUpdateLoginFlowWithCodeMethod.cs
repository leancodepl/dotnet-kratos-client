...
namespace LeanCode.Kratos.Client.Model
{
    ...
    /// </summary>
    public partial class KratosUpdateLoginFlowWithCodeMethod
    {
        /// <summary>
        ...
        [JsonConstructor]
        public KratosUpdateLoginFlowWithCodeMethod(string csrfToken, string method, Option<string?> code = default, Option<string?> identifier = default, Option<string?> resend = default, Option<Object?> transientPayload = default)
        {
            CsrfToken = csrfToken;
            Method = method;
            CodeOption = code;
    ...
    public class KratosUpdateLoginFlowWithCodeMethodJsonConverter : JsonConverter<KratosUpdateLoginFlowWithCodeMethod>
    {
        ...
        public override KratosUpdateLoginFlowWithCodeMethod Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new KratosUpdateLoginFlowWithCodeMethod(csrfToken.Value!, method.Value!, code, identifier, resend, transientPayload);
        }
