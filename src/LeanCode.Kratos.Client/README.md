...
inputSpec: https://raw.githubusercontent.com/ory/sdk/master/spec/kratos/v25.4.0.json
outputDir: out
...
namespace YourProject
{
    public class Program
    {
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) => Host.CreateDefaultBuilder(args)
          .ConfigureKratos((context, services, options) =>
          {
              ...
              options.AddKratosHttpClients(client =>
              {
