# LeanCode.Kratos.Client.Api.IdentityApi
...
namespace Example
{
    public class ListIdentitiesExample
    {
        public static void Main()
        {
            ...
            {
                // List Identities
                List<KratosIdentity> result = apiInstance.ListIdentities(ids, includeCredential, page, consistency, credentialsIdentifier, previewCredentialsIdentifierSimilar, perPage, pageSize, pageToken);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // List Identities
    ApiResponse<List<KratosIdentity>> response = apiInstance.ListIdentitiesWithHttpInfo(ids, includeCredential, page, consistency, credentialsIdentifier, previewCredentialsIdentifierSimilar, perPage, pageSize, pageToken);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="listsessions"></a>
# **ListSessions**
> List&lt;KratosSession&gt; ListSessions (List<string> expand = null, bool active = null, string pageToken = null, long pageSize = null)
