# LeanCode.Kratos.Client.Api.FrontendApi
...
> KratosLoginFlow CreateNativeLoginFlow (bool refresh = null, bool returnSessionTokenExchangeCode = null, string aal = null, string xSessionToken = null, string returnTo = null, string via = null)
...
namespace Example
{
    public class CreateNativeLoginFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Create Login Flow for Native Apps
                KratosLoginFlow result = apiInstance.CreateNativeLoginFlow(refresh, returnSessionTokenExchangeCode, aal, xSessionToken, returnTo, via);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Create Login Flow for Native Apps
    ApiResponse<KratosLoginFlow> response = apiInstance.CreateNativeLoginFlowWithHttpInfo(refresh, returnSessionTokenExchangeCode, aal, xSessionToken, returnTo, via);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
# **ListMySessions**
> List&lt;KratosSession&gt; ListMySessions (long page = null, string xSessionToken = null, string cookie = null, long perPage = null, long pageSize = null, string pageToken = null)
...
namespace Example
{
    public class ListMySessionsExample
    {
        public static void Main()
        {
            ...
            {
                // Get My Active Sessions
                List<KratosSession> result = apiInstance.ListMySessions(page, xSessionToken, cookie, perPage, pageSize, pageToken);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Get My Active Sessions
    ApiResponse<List<KratosSession>> response = apiInstance.ListMySessionsWithHttpInfo(page, xSessionToken, cookie, perPage, pageSize, pageToken);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
# **UpdateLoginFlow**
> KratosSuccessfulNativeLogin UpdateLoginFlow (KratosUpdateLoginFlowBody kratosUpdateLoginFlowBody, string flow, string xSessionToken = null, string cookie = null)
...
namespace Example
{
    public class UpdateLoginFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Submit a Login Flow
                KratosSuccessfulNativeLogin result = apiInstance.UpdateLoginFlow(kratosUpdateLoginFlowBody, flow, xSessionToken, cookie);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Submit a Login Flow
    ApiResponse<KratosSuccessfulNativeLogin> response = apiInstance.UpdateLoginFlowWithHttpInfo(kratosUpdateLoginFlowBody, flow, xSessionToken, cookie);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
# **UpdateRecoveryFlow**
> KratosRecoveryFlow UpdateRecoveryFlow (KratosUpdateRecoveryFlowBody kratosUpdateRecoveryFlowBody, string flow, string token = null, string cookie = null)
...
namespace Example
{
    public class UpdateRecoveryFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Update Recovery Flow
                KratosRecoveryFlow result = apiInstance.UpdateRecoveryFlow(kratosUpdateRecoveryFlowBody, flow, token, cookie);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Update Recovery Flow
    ApiResponse<KratosRecoveryFlow> response = apiInstance.UpdateRecoveryFlowWithHttpInfo(kratosUpdateRecoveryFlowBody, flow, token, cookie);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> KratosSuccessfulNativeRegistration UpdateRegistrationFlow (KratosUpdateRegistrationFlowBody kratosUpdateRegistrationFlowBody, string flow, string cookie = null)
...
namespace Example
{
    public class UpdateRegistrationFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Update Registration Flow
                KratosSuccessfulNativeRegistration result = apiInstance.UpdateRegistrationFlow(kratosUpdateRegistrationFlowBody, flow, cookie);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Update Registration Flow
    ApiResponse<KratosSuccessfulNativeRegistration> response = apiInstance.UpdateRegistrationFlowWithHttpInfo(kratosUpdateRegistrationFlowBody, flow, cookie);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
# **UpdateSettingsFlow**
> KratosSettingsFlow UpdateSettingsFlow (KratosUpdateSettingsFlowBody kratosUpdateSettingsFlowBody, string flow, string xSessionToken = null, string cookie = null)
...
namespace Example
{
    public class UpdateSettingsFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Complete Settings Flow
                KratosSettingsFlow result = apiInstance.UpdateSettingsFlow(kratosUpdateSettingsFlowBody, flow, xSessionToken, cookie);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Complete Settings Flow
    ApiResponse<KratosSettingsFlow> response = apiInstance.UpdateSettingsFlowWithHttpInfo(kratosUpdateSettingsFlowBody, flow, xSessionToken, cookie);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> KratosVerificationFlow UpdateVerificationFlow (KratosUpdateVerificationFlowBody kratosUpdateVerificationFlowBody, string flow, string token = null, string cookie = null)
...
namespace Example
{
    public class UpdateVerificationFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Complete Verification Flow
                KratosVerificationFlow result = apiInstance.UpdateVerificationFlow(kratosUpdateVerificationFlowBody, flow, token, cookie);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Complete Verification Flow
    ApiResponse<KratosVerificationFlow> response = apiInstance.UpdateVerificationFlowWithHttpInfo(kratosUpdateVerificationFlowBody, flow, token, cookie);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
